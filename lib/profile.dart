// ignore_for_file: unnecessary_brace_in_string_interps, prefer_const_constructors, avoid_print, deprecated_member_use, unused_import, prefer_const_constructors_in_immutables, non_constant_identifier_names
...
import 'package:ihelpu_app/editprofile.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void jojo() async {
    ...
    user_weight = TextEditingController(text: widget.list['user_height']);
    user_height = TextEditingController(text: widget.list['user_email']);
